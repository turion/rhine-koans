...
message =
    constMCl -- Perform the following side effect every time the clock ticks.
        (putStrLn "Hello Rhine!") -- This is the side effect to perform. Insert your message for the wildcard!

main :: IO ()
main =
    flow $ -- The program runs the given "Rhine", which now follows in the next lines.
